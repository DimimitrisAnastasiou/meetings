...
def plot_with_fit(data, group_col, x_col, y_col, output_folder):
    ...
    for group, color in zip(unique_groups, colors):
        ...
        popt, pcov = curve_fit(linear_fit, x_mid_R, y_mid_R)
        ...
        x_range = np.linspace(0, np.max(x_mid_R), 100)  # Adjust range as needed
        ...
        plt.scatter(x_mid_R, y_mid_R,  color=color)
